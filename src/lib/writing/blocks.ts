...
export const BLOCK_CATALOG: BlockDef[] = [
  // ─── Pre-writing ───
  {
    ...
    name: "Brainstorm",
    nameZh: "头脑风暴",
    description: "AI generates multiple angles and directions for your topic",
    category: "pre-writing",
    color: "#ee6c4d",
    mode: "chat",
    aiRole: "Generates 5-8 writing angles based on your topic — you pick the direction",
    auto: {
      needs: ["topic"],
      produces: "brainstorm",
      checkpoint: true,  // AI generates options, user picks
      promptKey: "brainstorm-options",
    },
  },
  {
    type: "audience",
    name: "Audience",
    nameZh: "受众画像",
    description: "AI profiles your likely readers and their expectations",
    category: "pre-writing",
    color: "#e07a5f",
    mode: "chat",
    aiRole: "Profiles 2-3 target audiences with their knowledge, expectations, and concerns",
    auto: {
      needs: ["topic", "brainstorm"],
      produces: "audience",
      checkpoint: true,  // AI generates profiles, user confirms
      promptKey: "audience-options",
    },
  },
  {
    type: "research",
    name: "Research",
    nameZh: "调研收集",
    description: "AI finds relevant evidence, sources, and supporting material",
    category: "pre-writing",
    color: "#d4775c",
    mode: "chat",
    aiRole: "Searches for and compiles relevant sources, data, and evidence for your topic",
    auto: {
      needs: ["topic", "thesis"],
      produces: "research",
      checkpoint: false,  // AI does the research itself
      promptKey: "research-auto",
    },
  },
  ...
  // ─── Planning ───
  {
    ...
    name: "Thesis",
    nameZh: "论点锤炼",
    description: "State your core argument — the one idea you want to defend",
    category: "planning",
    color: "#e0a458",
    mode: "chat",
    aiRole: "Collects your core argument. This is the one block where YOUR idea is the input.",
    auto: {
      needs: ["topic"],
      produces: "thesis",
      checkpoint: true,  // pure checkpoint: user provides thesis
  ...
  },
  {
    ...
    name: "Outline",
    nameZh: "大纲搭建",
    description: "AI drafts a structure based on your thesis — you adjust",
    category: "planning",
    color: "#d4983e",
    mode: "chat",
    aiRole: "Drafts an outline based on your thesis, then you review and adjust",
    auto: {
      needs: ["thesis"],
      produces: "outline",
      checkpoint: true,  // AI drafts outline, user adjusts
      promptKey: "outline-options",
    },
  },
  {
    type: "evidence-eval",
    name: "Evidence Eval",
    nameZh: "论据评估",
    description: "AI evaluates the strength and relevance of gathered evidence",
    category: "planning",
    color: "#c4892e",
    mode: "chat",
    aiRole: "Evaluates each piece of evidence for relevance, credibility, and sufficiency",
    auto: {
      needs: ["thesis", "research"],
      produces: "evidence-eval",
      checkpoint: false,
      promptKey: "evidence-eval-auto",
    },
  },
  ...
  // ─── Drafting ───
  {
    ...
    name: "Hook",
    nameZh: "开篇设计",
    description: "AI writes 3 opening options — you pick your favorite",
    category: "drafting",
    color: "#2d4a6f",
    mode: "chat",
    aiRole: "Writes 3 compelling opening paragraphs in different styles — you choose",
    auto: {
      needs: ["thesis", "outline"],
      produces: "hook",
      checkpoint: true,  // AI generates options, user picks
      promptKey: "hook-options",
    },
  },
  {
    type: "draft",
    name: "Draft",
    nameZh: "自由写作",
    description: "AI writes the full essay based on your ideas and structure",
    category: "drafting",
    color: "#3d5a80",
    mode: "editor",
    aiRole: "Writes the complete draft following your thesis, outline, and hook",
    auto: {
  ...
  },
  {
    ...
    nameZh: "论据编织",
    description: "AI weaves evidence and sources directly into your draft",
    category: "drafting",
    color: "#4d6a90",
    mode: "chat",
    aiRole: "Integrates research findings into the draft with proper introduction, citation, and analysis",
    auto: {
      needs: ["draft", "research"],
      produces: "evidence",
      checkpoint: false,
      promptKey: "evidence-auto",
    },
  },
  {
    ...
    nameZh: "反驳预演",
    description: "AI adds counterarguments and rebuttals to strengthen your essay",
    category: "drafting",
    color: "#5b7ea8",
    mode: "chat",
    aiRole: "Generates the strongest objections to your thesis and writes rebuttals into the essay",
    auto: {
      needs: ["draft", "thesis"],
      produces: "counterargument",
      checkpoint: false,
      promptKey: "counterargument-auto",
    },
  },
  {
    type: "conclusion",
    name: "Conclusion",
    nameZh: "收束总结",
    description: "AI writes a conclusion that synthesizes your argument",
    category: "drafting",
    color: "#6b8eb8",
    mode: "chat",
    aiRole: "Writes a conclusion that synthesizes (not repeats) your argument and opens a wider perspective",
    auto: {
      needs: ["draft", "thesis"],
      produces: "conclusion",
      checkpoint: false,
      promptKey: "conclusion-auto",
    },
  },
  ...
  // ─── Reviewing ───
  {
    ...
    name: "Peer Review",
    nameZh: "同伴互评",
    description: "AI generates structured peer review feedback on your draft",
    category: "reviewing",
    color: "#6a8e6a",
    mode: "checklist",
    aiRole: "Generates a detailed peer review with rubric scores, strengths, and specific suggestions",
    auto: {
      needs: ["draft"],
      produces: "peer-review",
      checkpoint: false,
      promptKey: "peer-review-auto",
    },
  },
  {
    type: "reader-sim",
    name: "Reader Sim",
    nameZh: "模拟读者",
    description: "AI simulates a first-time reader's honest reaction",
    category: "reviewing",
    color: "#5a9e6a",
    mode: "chat",
    aiRole: "Reads the draft as a real reader and reports confusion, engagement, and unanswered questions",
    auto: {
      needs: ["draft"],
      produces: "reader-sim",
      checkpoint: false,
      promptKey: "reader-sim-auto",
    },
  },
  ...
  // ─── Revising ───
  {
    ...
    name: "Analyze",
    nameZh: "七维分析",
    description: "AI scores 7 writing traits with specific annotations",
    category: "revising",
    color: "#5b8a72",
    mode: "editor",
  ...
  },
  {
    ...
    name: "Logic Check",
    nameZh: "逻辑审查",
    description: "AI finds logical fallacies and argument gaps",
    category: "revising",
    color: "#4a7c62",
    mode: "chat",
    aiRole: "Identifies logical fallacies, unsupported claims, and argument gaps with specific fixes",
    auto: {
      needs: ["draft", "thesis"],
      produces: "logic-check",
      checkpoint: false,
      promptKey: "logic-check-auto",
    },
  },
  {
    type: "voice-lab",
    name: "Voice Lab",
    nameZh: "风格实验室",
    description: "AI rewrites key passages at different warmth levels for comparison",
    category: "revising",
    color: "#7b6d8d",
    mode: "lab",
    aiRole: "Rewrites key passages at cold/neutral/warm temperatures so you can see what makes writing feel human",
    auto: {
      needs: ["draft"],
      produces: "voice-lab",
      checkpoint: false,
      promptKey: "voice-lab-auto",
    },
  },
  ...
  // ─── Editing ───
  {
    ...
    name: "Transitions",
    nameZh: "衔接打磨",
    description: "AI fixes weak paragraph-to-paragraph connections",
    category: "editing",
    color: "#9d7e63",
    mode: "chat",
    aiRole: "Identifies and fixes weak transitions between paragraphs and sections",
    auto: {
      needs: ["draft"],
      produces: "transitions",
      checkpoint: false,
      promptKey: "transitions-auto",
    },
  },
  {
    type: "style-edit",
    name: "Style Polish",
    nameZh: "风格打磨",
    description: "AI improves clarity, word choice, and sentence variety",
    category: "editing",
    color: "#8d6e63",
    mode: "chat",
    aiRole: "Rewrites for clarity, precision, and sentence variety while preserving meaning and voice",
    auto: {
      needs: ["draft"],
      produces: "style-edit",
      checkpoint: false,
      promptKey: "style-edit-auto",
    },
  },
  ...
  // ─── Publishing ───
  {
    ...
    name: "Submit Ready",
    nameZh: "提交检查",
    description: "AI runs a complete submission readiness checklist",
    category: "publishing",
    color: "#4a6896",
    mode: "checklist",
    aiRole: "Runs submission readiness checklist — format, citations, word count, completeness — and reports results",
    auto: {
      needs: ["draft", "grammar"],
      produces: "submit-ready",
      checkpoint: false,
      promptKey: "submit-ready-auto",
    },
  },
  ...
  // ─── Reflecting ───
  {
    ...
    name: "Self-Review",
    nameZh: "自我检查",
    description: "AI generates a personalized review based on trait scores and writing patterns",
    category: "reflecting",
    color: "#4a7c96",
    mode: "checklist",
    aiRole: "Generates personalized self-review with strengths, growth areas, and next steps",
    auto: {
      needs: ["draft", "analyze"],
      produces: "self-review",
      checkpoint: false,
      promptKey: "self-review-auto",
    },
  },
];
